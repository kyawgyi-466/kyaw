...
# Author mix: Zahid Islam (udp-zivpn) + UPK tweaks + 𝐀𝐔𝐍𝐆 𝐒𝐀𝐍 𝐏𝐀𝐍𝐄𝐋 UI polish
...
{% if not authed %}
  <div class="login-card">
    <div class="center"><img class="logo" src="{{ logo }}" alt="𝐀𝐔𝐍𝐆 𝐒𝐀𝐍 𝐏𝐀𝐍𝐄𝐋"></div>
    <h3 class="center">𝐀𝐔𝐍𝐆 𝐒𝐀𝐍 𝐏𝐀𝐍𝐄𝐋</h3>
