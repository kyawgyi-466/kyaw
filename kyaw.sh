...
# Author mix: Zahid Islam (udp-zivpn) + UPK tweaks + 𝐊𝐘𝐀𝐖 𝐀𝐔𝐍𝐆 𝐏𝐀𝐍𝐄𝐋 UI polish
...
{% if not authed %}
  <div class="login-card">
    <div class="center"><img class="logo" src="{{ logo }}" alt="𝐊𝐘𝐀𝐖 𝐀𝐔𝐍𝐆 𝐏𝐀𝐍𝐄𝐋"></div>
    <h3 class="center">𝐊𝐘𝐀𝐖 𝐀𝐔𝐍𝐆 𝐏𝐀𝐍𝐄𝐋</h3>
