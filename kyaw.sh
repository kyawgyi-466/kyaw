...
# Author mix: Zahid Islam (udp-zivpn) + UPK tweaks + 𝐌𝐘𝐀𝐓𝐇𝐄𝐑 𝐏𝐀𝐍𝐄𝐋 UI polish
...
LOGO_URL = "https://raw.githubusercontent.com/kyawgyi-466/kyaw/refs/heads/main/myather.jpeg"
...
{% if not authed %}
  <div class="login-card">
    <div class="center"><img class="logo" src="{{ logo }}" alt="𝐌𝐘𝐀𝐓𝐇𝐄𝐑 𝐏𝐀𝐍𝐄𝐋"></div>
    <h3 class="center">𝐌𝐘𝐀𝐓𝐇𝐄𝐑 𝐏𝐀𝐍𝐄𝐋</h3>
...
<header>
  <img src="{{ logo }}" alt="𝐌𝐘𝐀𝐓𝐇𝐄𝐑 𝐏𝐀𝐍𝐄𝐋"
