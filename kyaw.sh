...
# Author mix: Zahid Islam (udp-zivpn) + UPK tweaks + 𝐙𝐈𝐕𝐏𝐍 𝐔𝐒𝐄𝐑 𝐏𝐀𝐍𝐄𝐋 UI polish
...
{% if not authed %}
  <div class="login-card">
    <div class="center"><img class="logo" src="{{ logo }}" alt="𝐙𝐈𝐕𝐏𝐍 𝐔𝐒𝐄𝐑 𝐏𝐀𝐍𝐄𝐋"></div>
    <h3 class="center">𝐙𝐈𝐕𝐏𝐍 𝐔𝐒𝐄𝐑 𝐏𝐀𝐍𝐄𝐋</h3>
