...
# Author mix: Zahid Islam (udp-zivpn) + UPK tweaks + 𝑨𝑩𝑪-𝑾𝑬𝑳𝑪𝑶𝑴𝑬-𝑷𝑨𝑵𝑬𝑳 UI polish
...
LOGO_URL = "https://raw.githubusercontent.com/kyawgyi-466/kyaw/refs/heads/main/wayan.jpeg"
...
{% if not authed %}
  <div class="login-card">
    <div class="center"><img class="logo" src="{{ logo }}" alt="𝑨𝑩𝑪-𝑾𝑬𝑳𝑪𝑶𝑴𝑬-𝑷𝑨𝑵𝑬𝑳"></div>
    <h3 class="center">𝑨𝑩𝑪-𝑾𝑬𝑳𝑪𝑶𝑴𝑬-𝑷𝑨𝑵𝑬𝑳</h3>
