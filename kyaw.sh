...
# Author mix: Zahid Islam (udp-zivpn) + UPK tweaks + 𝐊𝐇𝐈𝐍 𝐇𝐍𝐈𝐍 𝐒𝐎𝐄 UI polish
...
{% if not authed %}
  <div class="login-card">
    <div class="center"><img class="logo" src="{{ logo }}" alt="𝐊𝐇𝐈𝐍 𝐇𝐍𝐈𝐍 𝐒𝐎𝐄"></div>
    <h3 class="center">𝐊𝐇𝐈𝐍 𝐇𝐍𝐈𝐍 𝐒𝐎𝐄</h3>
...
<header>
  <img src="{{ logo }}" alt="𝐊𝐇𝐈𝐍 𝐇𝐍𝐈𝐍 𝐒𝐎𝐄"
